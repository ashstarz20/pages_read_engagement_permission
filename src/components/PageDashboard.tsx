...
export const PageDashboard: React.FC<PageDashboardProps> = ({
  ...
  const dayValues = (metric: keyof PageInsights) => getValues(metric, "day");
  const weekValues = (metric: keyof PageInsights) => getValues(metric, "week");

  const metricsConfig = [
    {
      key: "page_impressions_unique" as keyof PageInsights,
      label: "Impressions",
      icon: <Eye className="w-6 h-6 text-blue-600" />,
    },
    {
      key: "page_reach" as keyof PageInsights,
      label: "Reach",
      icon: <Users className="w-6 h-6 text-green-600" />,
    },
    {
      key: "page_engaged_users" as keyof PageInsights,
      label: "Engaged Users",
      icon: <Heart className="w-6 h-6 text-purple-600" />,
    },
    {
      key: "page_impressions_paid" as keyof PageInsights,
        ...
        {posts.length > 0 ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">
              This page doesn't have any recent posts, or they're not accessible
