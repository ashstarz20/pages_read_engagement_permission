      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Fetching pages with pages_show_list permission
          </p>
        </div>
      </div>
    );
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-8 text-white">
            ...
            <p className="text-blue-100">
              Choose a page to view analytics and manage content
            </p>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="mb-6 p-4 bg-green-50 rounded-xl border border-green-200">
              ...
              <div className="text-sm text-green-800">
                ...
                permission. Found {pages.length} page
                {pages.length !== 1 ? "s" : ""} you can manage.
              </div>
            </div>
            ...
            {pages.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  You don't have any Facebook Pages to manage, or the pages
                  don't have the required permissions.
                </p>
                <p className="text-sm text-gray-500">
                  Make sure you're an admin of at least one Facebook Page to use
                  this application.
                </p>
              </div>
            )}
            ...
            <div className="mt-8 p-4 bg-blue-50 rounded-xl border border-blue-200">
              <div className="text-sm text-blue-800">
                <strong>Active Permissions:</strong> pages_show_list,
                pages_read_engagement, read_insights
                <br />
                <strong>Data Usage:</strong> Only aggregated, anonymized metrics
                are collected. No personal user data is retained.
              </div>
            </div>
